        ...
        if (event.which === 13) {
            ...
            if (value != "") {
                if ($(".search").attr("id") == "twitch-search") {
                    ...
                    value = value.replaceAll("https", "").replaceAll("http", "").replaceAll(":", "").replaceAll("/", "").replaceAll("www", "").replaceAll("youtube", "").replaceAll("youtu", "").replaceAll(".be", "").replaceAll(".com", "").replaceAll(".", "").replaceAll("embed", "").replaceAll("watch?v=", "").replaceAll("watch", "").replaceAll("v=", "").replaceAll("&", "").replaceAll("t=", "").replaceAll("=", "").replaceAll("?", "").substr(0, 11);
